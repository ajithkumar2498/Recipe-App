 ...
 const [recipes, setRecipes]=useState([])
  ...
  return <>
    ...
    <div className="recepies-container">
      { loader ? <div className="loader" style={{textAlign:'center'}}> <ClipLoader loading={loader} color = {color} size={80} aria-label="Loading Spinner" height={80} data-testid="loader" /></div> :
